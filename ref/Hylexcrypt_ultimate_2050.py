...
# -*- coding: utf-8 -*-
"""
HylexCrypt Ultimate 2050 - Unified Advanced Stego + Crypto Tool (single file)

Save as: hylexcrypt_ultimate_2050_full.py
Run: python hylexcrypt_ultimate_2050_full.py --help
...
# --- CLI Manual text ---
MANUAL_TEXT = r"""
HylexCrypt Ultimate 2050 - Full Manual
=====================================
...
1) Encode a message into one PNG carrier:
   python hylexcrypt_ultimate_2050_full.py encode carrier.png -o outdir -m "Top Secret" -p "StrongPass!2025"

2) Decode:
   python hylexcrypt_ultimate_2050_full.py decode outdir/carrier_stego.png -p "StrongPass!2025"

3) Encode with expiry (message expires logically after 60s):
   python hylexcrypt_ultimate_2050_full.py encode carrier.png -o outdir -m "Ephemeral" -p "Pass!" --expire 60

4) Wipe embedded message bits in place (keeps file):
   python hylexcrypt_ultimate_2050_full.py wipe-message outdir/carrier_stego.png

5) Schedule a background wipe (autowipe) that runs detached:
   python hylexcrypt_ultimate_2050_full.py encode carrier.png -o outdir -m "AutoWipe" -p "Pass!" --autowipe 120
